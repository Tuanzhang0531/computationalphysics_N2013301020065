...
## 软件池介绍  
  欢迎来到我的软件池，此软件池是为武汉大学物理科学与技术学院计算物理此门课程的学习而建立的，在此软件池中，会有一些关于计算物理作业的相关内容，用于该课程作业的提交，主要以超链接的形式给出。
...
## [第十四次作业](https://www.zybuluo.com/BertramLee/note/411816)
- 作业 6.6 6.12 6.16
...
## [期末论文](https://www.zybuluo.com/BertramLee/note/411986)
- 自由选题（可以综合书上习题）
- 程序必须自己编写
- A4两张双面打印（四面）
