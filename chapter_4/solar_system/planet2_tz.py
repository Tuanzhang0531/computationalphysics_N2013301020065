# -*- coding: utf-8 -*-
"""
Created on Fri Jun 17 11:46:09 2016
...
subplot(321)#3 numbers:the total number of rows,columns and the number of subplot
...
subplot(325)
plot(x_M5,y_M5,color='grey')
scatter(0,0,s=1,color='red')
title('beta=2.7',fontsize=15)
xlabel('x/AU')
xlim(-0.6,0.6)
ylabel('y/AU')
ylim(-0.6,0.6)
...
subplot(326)
plot(x_M6,y_M6,color='grey')
scatter(0,0,s=1,color='red')
title('beta=3.0',fontsize=15)
xlabel('x/AU')
xlim(-0.6,0.6)
ylabel('y/AU')
ylim(-0.6,0.6)

savefig('planet2_tz.png')
show()